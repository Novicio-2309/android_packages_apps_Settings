...
public class MoreInfoPreferenceController extends BasePreferenceController {

    public MoreInfoPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (preference != null) {
            ...
            if (titleView != null) {
                titleView.setText(mContext.getString(R.string.more_device_info));
            }
            if (summaryView != null) {
                summaryView.setVisibility(View.GONE); // Hide summary for "More info"
            }
        }
    }
}
