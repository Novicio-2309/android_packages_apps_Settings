 ...
 */
public class ValidatedEditTextAboutPreference extends CustomEditTextPreferenceCompat {
    ...
    public ValidatedEditTextAboutPreference(Context context, AttributeSet attrs,
            int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public ValidatedEditTextAboutPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public ValidatedEditTextAboutPreference(Context context) {
        super(context);
    }
